...
const PackagesPage = () => {
  ...
  const packageTypes = [
    ...
    },
    {
      ...
      description:
        "Comfortable family getaways with flexible itineraries, trusted stays, and private sightseeing",
      features: [
        "Experienced driver with strong local sightseeing knowledge",
        "Verified family-friendly stays with hotel details shared before booking",
        "Complimentary toy train ticket experience",
        "Daily complimentary breakfast",
        "Private cab for complete sightseeing",
      ],
    ...
    },
    {
      ...
      description:
        "Group-friendly travel plans with flexible itineraries, trusted stays, and private transfers",
      features: [
        "Dedicated driver with strong local sightseeing knowledge",
        "Comfortable, well-rated stays with hotel names shared before booking",
        "Complimentary toy train ticket experience",
        "Daily complimentary breakfast",
